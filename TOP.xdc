...
## Switches
#set_property -dict { PACKAGE_PIN A8    IOSTANDARD LVCMOS33 } [get_ports { ctr }]; #IO_L12N_T1_MRCC_16 Sch=sw[0]
...
#set_property -dict { PACKAGE_PIN J5    IOSTANDARD LVCMOS33 } [get_ports { out_state[1] }]; #IO_25_35 Sch=led[5]
#set_property -dict { PACKAGE_PIN T9    IOSTANDARD LVCMOS33 } [get_ports { out_state[2] }]; #IO_L24P_T3_A01_D17_14 Sch=led[6]
#set_property -dict { PACKAGE_PIN T10   IOSTANDARD LVCMOS33 } [get_ports { out_state[3] }]; #IO_L24N_T3_A00_D16_14 Sch=led[7]

## Buttons
set_property -dict {PACKAGE_PIN D9 IOSTANDARD LVCMOS33} [get_ports rst]
#set_property -dict { PACKAGE_PIN C9    IOSTANDARD LVCMOS33 } [get_ports { ctr }]; #IO_L11P_T1_SRCC_16 Sch=btn[1]
#set_property -dict { PACKAGE_PIN B9    IOSTANDARD LVCMOS33 } [get_ports { btn[2] }]; #IO_L11N_T1_SRCC_16 Sch=btn[2]
#set_property -dict { PACKAGE_PIN B8    IOSTANDARD LVCMOS33 } [get_ports { ctr }]; #IO_L12P_T1_MRCC_16 Sch=btn[3]
...
set_property -dict {PACKAGE_PIN A9 IOSTANDARD LVCMOS33} [get_ports RX_in]
...
#set_property -dict {PACKAGE_PIN C5 IOSTANDARD LVCMOS33} [get_ports echo]
#set_property -dict {PACKAGE_PIN C6 IOSTANDARD LVCMOS33} [get_ports triger]
...
set_property -dict { PACKAGE_PIN F5    IOSTANDARD LVCMOS33 } [get_ports { echo }]; #IO_0_35           	Sch=ck_a[0]		ChipKit pin=A0
set_property -dict { PACKAGE_PIN D8    IOSTANDARD LVCMOS33 } [get_ports { triger }]; #IO_L4P_T0_35      	Sch=ck_a[1]		ChipKit pin=A1
...
connect_debug_port u_ila_0/probe0 [get_nets [list {e_pulse[0]} {e_pulse[1]} {e_pulse[2]} {e_pulse[3]} {e_pulse[4]} {e_pulse[5]} {e_pulse[6]} {e_pulse[7]} {e_pulse[8]} {e_pulse[9]} {e_pulse[10]} {e_pulse[11]} {e_pulse[12]} {e_pulse[13]} {e_pulse[14]} {e_pulse[15]} {e_pulse[16]} {e_pulse[17]} {e_pulse[18]} {e_pulse[19]} {e_pulse[20]} {e_pulse[21]} {e_pulse[22]} {e_pulse[23]} {e_pulse[24]} {e_pulse[25]} {e_pulse[26]} {e_pulse[27]} {e_pulse[28]} {e_pulse[29]} {e_pulse[30]}]]
